...
public class BaseResourceHome extends SingletonResourceHome implements Initializable {
	...
	public Resource findSingleton() {
		...
		try {
			WorkflowTestService1Resource resource = new WorkflowTestService1Resource();
			resource.initialize();
			return resource;
		} catch (Exception e) {
	...
	public WorkflowTestService1Resource getResource(){
		WorkflowTestService1Resource serviceBaseResource;
		try {
	...
	public Resource find(ResourceKey key) throws ResourceException {
		WorkflowTestService1Resource resource = (WorkflowTestService1Resource) super.find(key);
     ...
     */
    public WorkflowTestService1Resource getAddressedResource() throws Exception {
        WorkflowTestService1Resource thisResource;
        thisResource = (WorkflowTestService1Resource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}