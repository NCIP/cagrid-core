 ...
 * 
 */
public class WorkflowTestService1Authorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://sample1.tests.workflow.cagrid.nci.nih.gov/WorkflowTestService1";
	
	
	public WorkflowTestService1Authorization() {
	}
	...
	public static void authorizeInvoke() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("invoke")){
			try{
				authorizeInvoke();
				return true;
			} catch (Exception e){
