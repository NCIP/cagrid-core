...
/**
 * Dcql2PartialResultsQueryStep
 * Executes a query allowing for partial results from
 * the target data services
 * 
 * @author ervin
 */
public class Dcql2PartialResultsQueryStep extends BaseDcql2QueryExecutionStep {

    private static final Log LOG = LogFactory.getLog(Dcql2PartialResultsQueryStep.class);
    ...
    public Dcql2PartialResultsQueryStep(String queryFilename, String goldFilename, FederatedQueryProcessorClient fqpClient,
    ...
    public void runStep() throws Throwable {
        ...
        FederatedQueryResultsRetrievalClient fqpResultsClient = fqpClient.queryAsynchronously(query, null, executionParameters);
    ...
    private void verifyStatusResourceProperty(FederatedQueryResultsRetrievalClient client) {
