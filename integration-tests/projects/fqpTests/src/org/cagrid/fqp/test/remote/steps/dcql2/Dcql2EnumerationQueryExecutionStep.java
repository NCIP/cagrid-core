...
import gov.nih.nci.cagrid.introduce.portal.common.jedit.InputHandler.paste;
...
import org.cagrid.cql.utilities.encoding.AnyNodeHandler;
...
/**
 * Dcql2EnumerationQueryExecutionStep
 * Executes a federated query using enumeration for results
 *  
 * @author ervin
 */
public class Dcql2EnumerationQueryExecutionStep extends BaseDcql2QueryExecutionStep {
    
    private static Log LOG = LogFactory.getLog(Dcql2EnumerationQueryExecutionStep.class);
    ...
    public Dcql2EnumerationQueryExecutionStep(String queryFilename, String goldFilename,
    ...
    private void enumerateAndVerify(FederatedQueryResultsRetrievalClient resultsClient) {
        // if successful, grab the response
    ...
    private DCQLQuery getCompletedQuery() {
        ...
        LOG.debug("Loading original DCQL 2 query from " + getQueryFilename());
