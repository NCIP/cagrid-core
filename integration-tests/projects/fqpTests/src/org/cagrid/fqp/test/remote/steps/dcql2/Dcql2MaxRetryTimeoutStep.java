...
public class Dcql2MaxRetryTimeoutStep extends BaseDcql2QueryExecutionStep {
    
    public static final String[] QUERY_URL_PLACEHOLDERS = {
        "DATA_SERVICE_1", "DATA_SERVICE_2"
    };
    
    private static Log LOG = LogFactory.getLog(Dcql2MaxRetryTimeoutStep.class);
    ...
    public Dcql2MaxRetryTimeoutStep(String queryFilename, String goldFilename,
        FederatedQueryProcessorClient fqpClient, String[] serviceUrls, int maxTimeout) {
