package org.cagrid.data.test.upgrades.from1pt2;
 ...
 *  Tests to upgrade a data service from 1.2 to current
 * 
 * @author <A HREF="MAILTO:ervin@bmi.osu.edu">David W. Ervin</A>  * 
 * @created Feb 20, 2007 
 * @version $Id: UpgradeFrom1pt2Tests.java,v 1.3 2008-10-28 13:51:36 dervin Exp $ 
 */
public class UpgradeFrom1pt2Tests extends BaseSystemTest {
    public static final String SERVICE_ZIP_NAME = "BasicDataService_1-2.zip";
    public static final String SERVICE_DIR_NAME = "BasicDataService_1-2";
    public static final String SERVICE_NAME = "BasicDataService";
    public static final String SERVICE_PACKAGE = "org.cagrid.test.data.basic";
    public static final String SERVICE_NAMESPACE = "http://basic.data.test.cagrid.org/BasicDataService";
    
	private DataTestCaseInfo testServiceInfo = null;
	private ServiceContainer container = null;
    
	public String getDescription() {
		return "Tests upgrade of a data service from version 1.2 to " + UpgradeTestConstants.getCurrentDataVersion();
	}
    
    
    public String getName() {
        return "Data Service 1_2 to " 
	...
	public static void main(String[] args) {
		...
		TestResult result = runner.doRun(new TestSuite(UpgradeFrom1pt2Tests.class));
