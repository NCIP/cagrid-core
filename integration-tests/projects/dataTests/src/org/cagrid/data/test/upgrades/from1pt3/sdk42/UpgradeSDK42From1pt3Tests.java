package org.cagrid.data.test.upgrades.from1pt3.sdk42;
...
/** 
 *  UpgradeSDK42From1pt3Tests
 *  Tests to upgrade a data service backed by caCORE SDK 4.2 from 1.3 to current
 * 
 * @author <A HREF="MAILTO:ervin@bmi.osu.edu">David W. Ervin</A>  * 
 * @created Feb 20, 2007 
 * @version $Id: UpgradeSDKFrom1pt2Tests.java,v 1.2 2008-11-26 15:48:07 dervin Exp $ 
 */
public class UpgradeSDK42From1pt3Tests extends BaseSystemTest {
	public static final String SERVICE_ZIP_NAME = "DataServiceWithSdk42_1-3.zip";
    public static final String SERVICE_DIR_NAME = "DataServiceWithSdk42_1-3";
    public static final String SERVICE_NAME = "DataServiceWithSdk42";
    public static final String SERVICE_PACKAGE = "org.cagrid.data.with.sdk42";
	...
	public String getDescription() {
		return "Tests upgrade of a data service backed by the SDK 4.2 from version 1.3 to " 
		+ UpgradeTestConstants.getCurrentDataVersion();
	}
    
    
    public String getName() {
        return "Data Service backed by the SDK 4_2 from 1_3 to " 
	...
	protected Vector<?> steps() {
        ...
        // caCORE SDK 4.2 style upgrader should add CQL 2 support
	...
	public static void main(String[] args) {
		...
		TestResult result = runner.doRun(new TestSuite(UpgradeSDK42From1pt3Tests.class));
