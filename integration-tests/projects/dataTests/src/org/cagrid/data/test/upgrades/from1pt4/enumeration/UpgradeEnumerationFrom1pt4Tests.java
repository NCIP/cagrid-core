...
*============================================================================
**/
package org.cagrid.data.test.upgrades.from1pt4.enumeration;
...
/** 
 *  UpgradeEnumerationFrom1pt4Tests
 *  Tests to upgrade an enumeration data service from 1.4 to current
 * 
 * @author <A HREF="MAILTO:ervin@bmi.osu.edu">David W. Ervin</A>  * 
 * @created Feb 20, 2007 
 * @version $Id: UpgradeEnumerationFrom1pt3Tests.java,v 1.1 2008-10-28 15:55:16 dervin Exp $ 
 */
public class UpgradeEnumerationFrom1pt4Tests extends BaseSystemTest {
    public static final String SERVICE_ZIP_NAME = "DataServiceWithWsEnum_1-4.zip";
    public static final String SERVICE_DIR_NAME = "DataServiceWithWsEnum_1-4";
	...
	public String getDescription() {
		return "Tests upgrade of an enumeration data service from version 1.4 to " + UpgradeTestConstants.getCurrentDataVersion();
	}
    
    
    public String getName() {
        return "Data Service With Enumeration 1_4 to " 
	...
	public static void main(String[] args) {
		...
		TestResult result = runner.doRun(new TestSuite(UpgradeEnumerationFrom1pt4Tests.class));
