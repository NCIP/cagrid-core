package org.cagrid.data.styles.cacore4.test.upgrade.from14;
...
public class SDK4DataServiceUpgradeTest extends UpgradeStory {
    ...
    public String getDescription() {
        return "Tests upgrading a caGrid 1.4 Data Service backed by caCORE SDK 4.0 to the current version";
    }
    ...
    public String getServiceZipName() {
        return "DataServiceWithSdk40-1.4.zip";
    }
}
