package org.cagrid.tests.data.styles.cacore42.upgrade;
...
import org.cagrid.tests.data.styles.cacore42.steps.InvokeCQL2DataServiceStep;
...
public abstract class UpgradeStory extends BaseSystemTest {
    ...
    protected Vector<?> steps() {
        ...
        // steps.add(new InvokeDataServiceStep(testServiceInfo, container));
        // steps.add(new InvokeCQL2DataServiceStep(container, testServiceInfo));
        return steps;
    }
