...
public class InvokeCQL2DataServiceStep extends Step {
    ...
    public InvokeCQL2DataServiceStep(ServiceContainer container, DataTestCaseInfo testInfo) {
    ...
    private CQLQuery loadQuery(String filename) {
        ...
        CQLQuery query = null;
        try {
            InputStream queryInputStream = InvokeCQL2DataServiceStep.class.getResourceAsStream(fullFilename);
    ...
    private CQLQueryResults loadQueryResults(String filename)  {
        ...
        try {
            InputStream resultInputStream = InvokeCQL2DataServiceStep.class.getResourceAsStream(fullFilename);
