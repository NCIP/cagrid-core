package org.cagrid.tests.data.styles.cacore42.upgrade.from13;
...
public class SDK42DataServiceUpgradeTest extends UpgradeStory {
    ...
    public String getDescription() {
        return "Tests upgrading a caGrid 1.3 Data Service backed by caCORE SDK 4.2 to the current version";
    }
    ...
    public String getServiceZipName() {
        return "DataServiceWithSdk42-1.3.zip";
    }
}
