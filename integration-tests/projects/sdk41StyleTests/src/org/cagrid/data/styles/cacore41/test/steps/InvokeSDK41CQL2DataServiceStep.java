 ...
 */
public class InvokeSDK41CQL2DataServiceStep extends Step {
    ...
    private static Log LOG = LogFactory.getLog(InvokeSDK41CQL2DataServiceStep.class);
    
    private ServiceContainer container;
    private DataTestCaseInfo testInfo;

    public InvokeSDK41CQL2DataServiceStep(ServiceContainer container, DataTestCaseInfo testInfo) {
    ...
    private CQLQuery loadQuery(String filename) {
        ...
        CQLQuery query = null;
        try {
            InputStream queryInputStream = InvokeSDK41CQL2DataServiceStep.class.getResourceAsStream(fullFilename);
    ...
    private CQLQueryResults loadQueryResults(String filename)  {
        ...
        try {
            InputStream resultInputStream = InvokeSDK41CQL2DataServiceStep.class.getResourceAsStream(fullFilename);
    ...
    private InputStream getClientConfigStream() {
        ...
        try {
            is = InvokeSDK41CQL2DataServiceStep.class.getResourceAsStream(resourceName);
        } catch (Exception ex) {
            ex.printStackTrace();
