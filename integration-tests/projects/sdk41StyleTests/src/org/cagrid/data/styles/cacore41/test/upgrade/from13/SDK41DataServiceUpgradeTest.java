package org.cagrid.data.styles.cacore41.test.upgrade.from13;
...
public class SDK41DataServiceUpgradeTest extends UpgradeStory {
    ...
    public String getDescription() {
        return "Tests upgrading a caGrid 1.3 Data Service backed by caCORE SDK 4.1 to the current version";
    }
    ...
    public String getServiceZipName() {
        return "DataServiceWithSdk41-1.3.zip";
    }
}
