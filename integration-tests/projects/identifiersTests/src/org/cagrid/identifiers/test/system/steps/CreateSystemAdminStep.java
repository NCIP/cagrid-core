...
public class CreateSystemAdminStep extends Step {
    ...
    protected void runAntTarget(File projectDir, String adminIdentity) throws Exception {
        ...
        try {
            addAdminProcess = Runtime.getRuntime().exec(commandArray, editedEnvironment, projectDir);
            new StreamGobbler(addAdminProcess.getInputStream(), StreamGobbler.TYPE_OUT, System.out).start();
            new StreamGobbler(addAdminProcess.getErrorStream(), StreamGobbler.TYPE_OUT, System.err).start();
