 ...
 * 
 */
public class WorkflowTestService2Authorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://sample2.tests.workflow.cagrid.nci.nih.gov/WorkflowTestService2";
	
	
	public WorkflowTestService2Authorization() {
	}
