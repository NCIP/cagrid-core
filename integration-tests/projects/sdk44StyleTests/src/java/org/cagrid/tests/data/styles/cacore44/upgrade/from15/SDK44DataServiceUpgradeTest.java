...
*============================================================================
**/
package org.cagrid.tests.data.styles.cacore44.upgrade.from15;
...
public class SDK44DataServiceUpgradeTest extends UpgradeStory {
    ...
    public String getDescription() {
        return "Tests upgrading a caGrid 1.5 Data Service backed by caCORE SDK 4.4 to the current version";
    }
    ...
    public String getServiceZipName() {
        return "DataServiceWithSdk44-1.5.zip";
    }
}
