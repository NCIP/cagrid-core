...
public class CreateDataServiceStep extends CreationStep {
    ...
    /**
     * Extended to turn on and configure the caCORE SDK 4.4 style in the service model
     */
    ...
    private void setServiceStyle() throws Throwable {
        ...
        features.setServiceStyle(new ServiceStyle(
            SDK44ServiceStyleSystemTestConstants.STYLE_NAME, SDK44ServiceStyleSystemTestConstants.STYLE_VERSION));
