...
import org.cagrid.tests.data.styles.cacore44.integration.steps.CreateDataServiceStep;
import org.cagrid.tests.data.styles.cacore44.integration.steps.DeployExampleProjectStep;
import org.cagrid.tests.data.styles.cacore44.integration.steps.InvokeCql2DataServiceStep;
import org.cagrid.tests.data.styles.cacore44.integration.steps.InvokeDataServiceStep;

public class SDK44StyleRemoteApiStory extends Story {
    ...
    public SDK44StyleRemoteApiStory() {
        super();
    }


    public String getDescription() {
        return "Creates an SDK 4.4 with ISO types style data service, configures it to use the remote API, deploys and invokes it.";
    }
    
    
    public String getName() {
        return "SDK 4_4 with ISO types Style data service using remote API creation and invocation test";
    }
    ...
    public String getIntroduceBaseDir() {
        String dir = System.getProperty(SDK44ServiceStyleSystemTestConstants.INTRODUCE_DIR_PROPERTY);
        assertNotNull("Introduce base dir system property " + 
            SDK44ServiceStyleSystemTestConstants.INTRODUCE_DIR_PROPERTY + " is required", dir);
        return dir;
    }
}
