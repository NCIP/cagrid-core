...
public class SDK44StyleLocalApiStory extends Story {
    
    private DataTestCaseInfo testInfo = null;
    private ServiceContainer container = null;

    public SDK44StyleLocalApiStory() {
        super();
    }


    public String getDescription() {
        return "Creates an SDK 4.4 with ISO types style data service, configures it to use the local API, deploys and invokes it.";
    }
    
    
    public String getName() {
        return "SDK 4_4 with ISO types Style data service using local API creation and invocation test";
    }
