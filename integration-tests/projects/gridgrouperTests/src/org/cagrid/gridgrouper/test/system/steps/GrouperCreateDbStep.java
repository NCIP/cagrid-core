...
public class GrouperCreateDbStep extends Step {
	...
	public void runStep() throws Exception {
		...
		// target to execute
		command.add("createTestDatabase");
		...
		try {
			...
			throw new ContainerException("Error invoking grid grouper createTestDatabase process: " + ex.getMessage(), ex);
		}

		if (initProcess.exitValue() != 0) {
			throw new ContainerException("createTestDatabase ant command failed: " + initProcess.exitValue());
		}
