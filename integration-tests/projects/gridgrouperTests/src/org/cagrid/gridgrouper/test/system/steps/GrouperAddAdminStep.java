...
public class GrouperAddAdminStep extends Step {
	...
	public void runStep() throws Throwable {
		...
		command.add("-DgridId.input=" + userName);
		...
		try {
			...
			throw new ContainerException("Error invoking grid grouper addAdmin process: " + ex.getMessage(), ex);
		}

		if (initProcess.exitValue() != 0) {
			throw new ContainerException("addAdmin ant command failed: " + initProcess.exitValue());
		}
