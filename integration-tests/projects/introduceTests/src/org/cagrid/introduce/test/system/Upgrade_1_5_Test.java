...
public class Upgrade_1_5_Test extends Story {
    private TestCaseInfo tci1;

    private ServiceContainer container;


    public Upgrade_1_5_Test() {
    ...
    protected Vector<Step> steps() {
        ...
        try {
            ...
            steps.add(new UnzipOldServiceStep(Utils.decodeUrl(this.getClass().getResource(
                "/gold/serviceVersions/" + "IntroduceTestService-1_5.zip")), this.tci1));
    ...
    public static void main(String args[]) {
        ...
        TestResult result = runner.doRun(new TestSuite(Upgrade_1_5_Test.class));
