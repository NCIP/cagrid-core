...
/**
 * Tomcat6ServiceContainer 
 * Service container implementation for Tomcat 6
 * 
 * @author David Ervin
 */
public class Tomcat6ServiceContainer extends ServiceContainer {
	...
	public Tomcat6ServiceContainer(ContainerProperties properties) {
		super(properties);
	}
	...
	protected void shutdown() throws ContainerException {
		...
		String shutdownExecutable = getProperties().getContainerDirectory().getAbsolutePath()
