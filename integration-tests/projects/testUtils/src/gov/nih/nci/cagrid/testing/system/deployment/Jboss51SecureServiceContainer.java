...
/**
 * Jboss51SecureServiceContainer 
 * Secure service container implementation for JBoss 5.1
 * 
 * @author David Ervin
 */
public class Jboss51SecureServiceContainer extends Jboss51ServiceContainer implements SecureContainer {
	...
	public Jboss51SecureServiceContainer(ContainerProperties properties) {
        super(properties);
    }
	...
	public void unpackContainer() throws ContainerException {
        ...
        File serverConfFile = new File(getProperties().getContainerDirectory(), "server/default/deploy/jbossweb.sar/server.xml");
