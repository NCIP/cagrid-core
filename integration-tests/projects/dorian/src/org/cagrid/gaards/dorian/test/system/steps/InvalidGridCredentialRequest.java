...
public class InvalidGridCredentialRequest implements GridCredentialRequestOutcome {
    ...
    public void check(GlobusCredential credential, Throwable e) throws Exception {
        if (e == null) {
            throw new Exception("No error was received when one was expected!!!");
        }
        ...
        } else if ((this.errorMessage != null) && (Utils.getExceptionMessage(e).indexOf(this.errorMessage) == -1)) {
            throw new Exception(
