...
public class FindLocalUserStep extends Step {
    ...
    public FindLocalUserStep(String serviceURL, GridCredentialRequestStep admin, Application app,
    ...
    public void runStep() throws Throwable {
        LocalAdministrationClient client = new LocalAdministrationClient(serviceURL, this.admin.getGridCredential());
        ...
        assertEquals(this.application.getFirstName(), users.get(0).getFirstName());
        assertEquals(this.application.getLastName(), users.get(0).getLastName());
        assertEquals(this.application.getOrganization(), users.get(0).getOrganization());
        ...
        assertEquals(this.application.getPhoneNumber(), users.get(0).getPhoneNumber());
