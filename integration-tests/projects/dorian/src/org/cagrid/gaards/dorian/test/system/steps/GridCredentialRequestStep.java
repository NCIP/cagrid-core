...
public class GridCredentialRequestStep extends Step {
    ...
    public GridCredentialRequestStep(String serviceURL, AuthenticationStep auth, GridCredentialRequestOutcome outcome) {
    ...
    public void runStep() throws Throwable {
        ...
        try {
            ...
            this.gridCredential = client.requestUserCertificate(this.auth.getSAML(), lifetime);
        } catch (Throwable e) {
            error = e;
        }
