...
public class ReplayCacheFactory
{
    ...
    public static ReplayCache getInstance() throws NoSuchProviderException {
        return getInstance(null, SAMLConfig.instance().getProperty("gov.nih.nci.cagrid.opensaml.provider.replaycache"));
    }
    ...
    public static ReplayCache getInstance(Element e) throws NoSuchProviderException {
        return getInstance(e, SAMLConfig.instance().getProperty("gov.nih.nci.cagrid.opensaml.provider.replaycache"));
    }
