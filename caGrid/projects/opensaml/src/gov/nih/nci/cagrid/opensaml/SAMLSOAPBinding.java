...
public interface SAMLSOAPBinding extends SAMLBinding
{
    ...
    public interface SOAPHook {
         ...
         * @throws  SAMLException   Raised by hook if an error occurs, aborts receipt
         */
         ...
         * @throws  SAMLException   Raised by hook if an error occurs, aborts transmission
         */
     ...
     * @throws SAMLException    Raised if an error occurs in preparing the SOAP message
     */
     ...
     * @throws SAMLException    Raised if the SAML request cannot be unpacked successfully
     */
     ...
     * @throws SAMLException    Raised if the SAML response cannot be unpacked successfully
