...
public class SAMLBrowserProfileFactory
{
    ...
    public static SAMLBrowserProfile getInstance() throws NoSuchProviderException {
        return getInstance(null, SAMLConfig.instance().getProperty("gov.nih.nci.cagrid.opensaml.provider.browserprofile"));
    }
    ...
    public static SAMLBrowserProfile getInstance(Element e) throws NoSuchProviderException {
        return getInstance(e, SAMLConfig.instance().getProperty("gov.nih.nci.cagrid.opensaml.provider.browserprofile"));
    }
