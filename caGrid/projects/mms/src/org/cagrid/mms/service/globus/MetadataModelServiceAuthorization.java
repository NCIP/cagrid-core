 ...
 * 
 */
public class MetadataModelServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://mms.cagrid.org/MetadataModelService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public MetadataModelServiceAuthorization() {
	}
