 ...
 * 
 */
public class MetadataModelServiceResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(MetadataModelServiceResourceHome.class);
	...
	public Resource find(ResourceKey key) throws ResourceException {
		MetadataModelServiceResource resource = (MetadataModelServiceResource) super.find(key);
		return resource;
	}
     ...
     */
    public MetadataModelServiceResource getAddressedResource() throws Exception {
        MetadataModelServiceResource thisResource;
        thisResource = (MetadataModelServiceResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}