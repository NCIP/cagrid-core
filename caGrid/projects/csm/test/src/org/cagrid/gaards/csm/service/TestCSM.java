...
public class TestCSM extends TestCase {
            ...
            try {
             ...
             try {
              ...
              try {
               ...
               // Test that a super admin, can create search for, and remove a protection element.
    ...
    private void compareProtectionElements(ProtectionElement e1, ProtectionElement e2){
        ...
        assertEquals(gov.nih.nci.cagrid.common.Utils.clean(e1.getAttributeValue()), gov.nih.nci.cagrid.common.Utils.clean(e2.getAttributeValue()));
