...
/**
 * CreationStep Step to create a BDT service using the Introduce engine
 * 
 * @created Aug 22, 2006
...
public class CreationStep extends Step {
    ...
    public void runStep() throws Throwable {
        ...
        List<String> cmd = AntTools.getAntSkeletonCreationCommand(introduceDir, CreationTest.SERVICE_NAME,
            CreationTest.SERVICE_DIR, CreationTest.PACKAGE_NAME, CreationTest.SERVICE_NAMESPACE,
            IntroduceConstants.INTRODUCE_MAIN_RESOURCE + "," + IntroduceConstants.INTRODUCE_SINGLETON_RESOURCE, "bdt");
    ...
    private void addBdtMethods() throws Throwable {
        ...
        assertTrue("Service model file cannot be read: " + serviceModelFile.getAbsolutePath(), serviceModelFile
            .canRead());

        // deserialize the service model
        System.out.println("Deserializing service description from introduce.xml");
        ServiceDescription serviceDesc = (ServiceDescription) Utils.deserializeDocument(serviceModelFile
            .getAbsolutePath(), ServiceDescription.class);
    ...
    private void addBdtMethodReturnsBdtReference(ServiceDescription serviceDesc) throws Throwable {
        ...
        QName referenceQname = new QName("http://cagrid.nci.nih.gov/BulkDataHandlerReference",
    ...
    private void addBdtMethodReturnsClientHandle(ServiceDescription serviceDesc) throws Throwable {
        ...
        QName handleQname = new QName(mainService.getNamespace() + "BDT/types", mainService.getName()
            + "BulkDataHandlerReference");
        ...
        String clientHandleClass = mainService.getPackageName() + ".bdt.client." + mainService.getName()
