...
import gov.nih.nci.cagrid.graph.uml.layout.LayoutedNode;
 ...
 * </ul>
 */
public class ClassdiagramNode implements LayoutedNode, Comparable {
    ...
    public boolean isComment() {
        // CHANGED BY ME: return (getFigure() instanceof FigComment);
        return false;
    }
    ...
    public boolean isPackage() {
        // CHANGED BY ME: return (getFigure() instanceof FigPackage);
        return false;
    }
