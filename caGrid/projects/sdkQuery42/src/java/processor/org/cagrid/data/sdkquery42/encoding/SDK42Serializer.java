...
/**
 * SDK42Serializer
 * Serializes beans from the caCORE SDK version 4.2
 * using Castor to do the heavy lifting
 * 
 * @author David
 */
public class SDK42Serializer implements Serializer {

	protected static Log LOG = LogFactory.getLog(SDK42Serializer.class.getName());
	...
	public void serialize(QName name, Attributes attributes, Object value, SerializationContext context)
		...
		try {
			Mapping mapping = SDK42EncodingUtils.getMarshallerMapping(context.getMessageContext());
