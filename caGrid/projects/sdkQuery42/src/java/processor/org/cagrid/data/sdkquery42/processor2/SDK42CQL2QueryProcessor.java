...
public class SDK42CQL2QueryProcessor extends CQL2QueryProcessor {// general configuration options
    ...
    private static Log LOG = LogFactory.getLog(SDK42CQL2QueryProcessor.class);
