...
/**
 * SDK42Deserializer
 * Deserializes beans from the caCORE SDK version 4.2
 * using Castor to do the heavy lifting
 * 
 * @author David
 */
public class SDK42Deserializer extends DeserializerImpl implements Deserializer {
	public QName xmlType;
	public Class<?> javaType;

	protected static Log LOG = LogFactory.getLog(SDK42Deserializer.class.getName());


	public SDK42Deserializer(Class<?> javaType, QName xmlType) {
	...
	public void onEndElement(String namespace, String localName, DeserializationContext context) {
		...
		try {
			Mapping mapping = SDK42EncodingUtils.getUnmarshallerMapping(context.getMessageContext());
			if (mapping != null) {
