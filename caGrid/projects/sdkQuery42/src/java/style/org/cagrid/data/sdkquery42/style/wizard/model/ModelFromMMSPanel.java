...
public class ModelFromMMSPanel extends DomainModelSourcePanel {
    ...
    public DomainModelConfigurationSource getSourceType() {
        return DomainModelConfigurationSource.MMS;
    }
    ...
    private InternalCaDSRBrowserPanel getCadsrBrowser() {
        if (cadsrBrowser == null) {
            ...
            getConfiguration().setMmsUrl(url);
            cadsrBrowser.getCadsr().getDocument().addDocumentListener(new DocumentChangeAdapter() {
                public void documentEdited(DocumentEvent e) {
                    getConfiguration().setMmsUrl(getCadsrBrowser().getCadsr().getText());
                }
            });
        }
        return cadsrBrowser;
