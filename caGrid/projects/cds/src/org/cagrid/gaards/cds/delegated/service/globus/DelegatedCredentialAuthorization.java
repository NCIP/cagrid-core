 ...
 * 
 */
public class DelegatedCredentialAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://cds.gaards.cagrid.org/CredentialDelegationService/DelegatedCredential";
	
	Map authorizationClassMap = new HashMap();
	
	
	public DelegatedCredentialAuthorization() {
	}
	...
	public void authorizeGetDelegatedCredential(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getDelegatedCredential")){
			authorizeGetDelegatedCredential(peerSubject, context, operation);
			return true;
