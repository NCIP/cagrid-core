 ...
 */
public abstract class DelegatedCredentialClientBase extends ServiceSecurityClient {	
	...
	public DelegatedCredentialClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public DelegatedCredentialClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected DelegatedCredentialPortType createPortType() throws RemoteException {
