 ...
 * 
 */
public abstract class CredentialDelegationServiceResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(CredentialDelegationServiceResourceBase.class);

	private CredentialDelegationServiceResourceConfiguration configuration;
    ...
    public CredentialDelegationServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((CredentialDelegationServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(CredentialDelegationServiceConstants.SERVICEMETADATA);
	...
	public CredentialDelegationServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/CredentialDelegationService";
		...
		try {
			...
			this.configuration = (CredentialDelegationServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((CredentialDelegationServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
