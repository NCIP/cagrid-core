...
public class GridGrouperResourceHome extends SingletonResourceHomeImpl implements Initializable {
	...
	static final Log logger = LogFactory.getLog(GridGrouperResourceHome.class);
	...
	public Resource find(ResourceKey key) throws ResourceException {
		GridGrouperResource resource = (GridGrouperResource) super.find(key);
		return resource;
	}
     ...
     */
    public GridGrouperResource getAddressedResource() throws Exception {
        GridGrouperResource thisResource;
        thisResource = (GridGrouperResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}