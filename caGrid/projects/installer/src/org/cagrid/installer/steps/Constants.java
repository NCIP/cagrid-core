...
public abstract class Constants {
    ...
    public static final String HOST_CREDS_SELECTION_TYPE = "host.creds.selection.type";
    ...
    public static final String JBOSS_TEMP_FILE_NAME = "jboss.temp.file.name";
    ...
    public static final String OLD_HTTP_PORT = "old.http.port";
