 ...
 * 
 */
public class IdentifiersNAServiceResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(IdentifiersNAServiceResourceHome.class);
	...
	public Resource find(ResourceKey key) throws ResourceException {
		IdentifiersNAServiceResource resource = (IdentifiersNAServiceResource) super.find(key);
		return resource;
	}
