 ...
 */
public abstract class IdentifiersNAServiceClientBase extends ServiceSecurityClient {	
	protected IdentifiersNAServicePortType portType;
	...
	public IdentifiersNAServiceClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public IdentifiersNAServiceClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
