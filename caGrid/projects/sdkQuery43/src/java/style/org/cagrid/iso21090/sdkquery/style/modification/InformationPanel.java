package org.cagrid.iso21090.sdkquery.style.modification;
...
public class InformationPanel extends DataServiceModificationSubPanel {
    ...
    public void updateDisplayedConfiguration() throws Exception {
        String applicationName = getQueryProcessorProperty(
            SDK43QueryProcessor.PROPERTY_APPLICATION_NAME);
        ...
        String useLocalValue = getQueryProcessorProperty(
            SDK43QueryProcessor.PROPERTY_USE_LOCAL_API);
        ...
        if (!useLocal) {
            String hostname = getQueryProcessorProperty(SDK43QueryProcessor.PROPERTY_HOST_NAME);
            String port = getQueryProcessorProperty(SDK43QueryProcessor.PROPERTY_HOST_PORT);
            String useHttpsValue = getQueryProcessorProperty(SDK43QueryProcessor.PROPERTY_HOST_HTTPS);
        ...
        String useGridIdentValue = getQueryProcessorProperty(SDK43QueryProcessor.PROPERTY_USE_GRID_IDENTITY_LOGIN);
