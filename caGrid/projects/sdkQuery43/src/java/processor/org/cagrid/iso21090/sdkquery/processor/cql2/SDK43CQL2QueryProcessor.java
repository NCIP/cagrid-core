...
import org.cagrid.iso21090.sdkquery.processor.CQLAttributeDefaultPredicateUtil;
...
/**
 * SDK43CQL2QueryProcessor
 * CQL 2 Query processor for caCORE SDK 4.3 with ISO 21090 data types 
 * 
 * @author David W. Ervin
 */
public class SDK43CQL2QueryProcessor extends CQL2QueryProcessor {
    
    private static Log LOG = LogFactory.getLog(SDK43CQL2QueryProcessor.class);
