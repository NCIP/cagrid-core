 ...
 * @author David
 */
public class SDK43Deserializer extends DeserializerImpl implements Deserializer {
	public QName xmlType;
	public Class<?> javaType;

	protected static Log LOG = LogFactory.getLog(SDK43Deserializer.class.getName());


	public SDK43Deserializer(Class<?> javaType, QName xmlType) {
	...
	public void onEndElement(String namespace, String localName, DeserializationContext context) {
		...
		try {
			Mapping mapping = SDK43EncodingUtils.getUnmarshallerMapping(context.getMessageContext());
			if (mapping != null) {
