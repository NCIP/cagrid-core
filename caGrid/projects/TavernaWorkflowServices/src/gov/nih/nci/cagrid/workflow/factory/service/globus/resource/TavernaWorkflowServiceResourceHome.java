 ...
 * 
 */
public class TavernaWorkflowServiceResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(TavernaWorkflowServiceResourceHome.class);
	...
	public Resource find(ResourceKey key) throws ResourceException {
		TavernaWorkflowServiceResource resource = (TavernaWorkflowServiceResource) super.find(key);
		return resource;
	}
