...
public abstract class TavernaWorkflowServiceClientBase extends ServiceSecurityClient {	
	...
	public TavernaWorkflowServiceClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public TavernaWorkflowServiceClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
