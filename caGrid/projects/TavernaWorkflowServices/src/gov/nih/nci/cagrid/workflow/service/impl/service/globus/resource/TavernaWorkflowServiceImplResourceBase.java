...
public abstract class TavernaWorkflowServiceImplResourceBase extends ReflectionResource implements Resource
	...
	static final Log logger = LogFactory.getLog(TavernaWorkflowServiceImplResourceBase.class);

	private TavernaWorkflowServiceImplResourceConfiguration configuration;
    ...
    public TavernaWorkflowServiceImplResourceBase() {
        try {
            resourcePropertyPersistenceHelper = new gov.nih.nci.cagrid.introduce.servicetools.XmlPersistenceHelper(TavernaWorkflowServiceImplResourceProperties.class,TavernaWorkflowServiceConfiguration.getConfiguration());
	...
	public workflowmanagementfactoryservice.WorkflowStatusType getWorkflowStatusElement(){
		return ((TavernaWorkflowServiceImplResourceProperties) getResourceBean()).getWorkflowStatusElement();
	}
	
	public void setWorkflowStatusElement(workflowmanagementfactoryservice.WorkflowStatusType workflowStatusElement ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(TavernaWorkflowServiceImplConstants.WORKFLOWSTATUSELEMENT);
