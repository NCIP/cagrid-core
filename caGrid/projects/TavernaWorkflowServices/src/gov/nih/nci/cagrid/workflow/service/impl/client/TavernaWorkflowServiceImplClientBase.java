...
public abstract class TavernaWorkflowServiceImplClientBase extends ServiceSecurityClient implements NotifyCallback {	
	...
	public TavernaWorkflowServiceImplClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public TavernaWorkflowServiceImplClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
