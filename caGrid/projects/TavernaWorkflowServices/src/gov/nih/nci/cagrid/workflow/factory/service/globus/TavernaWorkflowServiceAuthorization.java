 ...
 * 
 */
public class TavernaWorkflowServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://factory.workflow.cagrid.nci.nih.gov/TavernaWorkflowService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public TavernaWorkflowServiceAuthorization() {
	}
	...
	public void authorizeCreateWorkflow(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("createWorkflow")){
			authorizeCreateWorkflow(peerSubject, context, operation);
			return true;
