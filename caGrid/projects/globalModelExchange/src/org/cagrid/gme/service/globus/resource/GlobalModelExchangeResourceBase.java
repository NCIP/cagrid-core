 ...
 * 
 */
public abstract class GlobalModelExchangeResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(GlobalModelExchangeResourceBase.class);

	private GlobalModelExchangeResourceConfiguration configuration;
    ...
    public GlobalModelExchangeResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((GlobalModelExchangeResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(GlobalModelExchangeConstants.SERVICEMETADATA);
	...
	public GlobalModelExchangeResourceConfiguration getConfiguration() {
		...
		servicePath+="/GlobalModelExchange";
		...
		try {
			...
			this.configuration = (GlobalModelExchangeResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
