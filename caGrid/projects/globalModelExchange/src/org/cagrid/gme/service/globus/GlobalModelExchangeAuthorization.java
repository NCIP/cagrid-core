...
public class GlobalModelExchangeAuthorization implements PDP {
	...
	public void authorizePublishXMLSchemas(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetXMLSchema(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetXMLSchemaNamespaces(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetXMLSchemaAndDependencies(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeDeleteXMLSchemas(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetImportedXMLSchemaNamespaces(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetImportingXMLSchemaNamespaces(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			authorizePublishXMLSchemas(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getXMLSchema")){
			authorizeGetXMLSchema(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getXMLSchemaNamespaces")){
			authorizeGetXMLSchemaNamespaces(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getXMLSchemaAndDependencies")){
			authorizeGetXMLSchemaAndDependencies(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("deleteXMLSchemas")){
			authorizeDeleteXMLSchemas(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getImportedXMLSchemaNamespaces")){
			authorizeGetImportedXMLSchemaNamespaces(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getImportingXMLSchemaNamespaces")){
			authorizeGetImportingXMLSchemaNamespaces(peerSubject, context, operation);
			return true;
