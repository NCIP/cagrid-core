 ...
 */
public abstract class GlobalModelExchangeClientBase extends ServiceSecurityClient {	
	...
	public GlobalModelExchangeClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public GlobalModelExchangeClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
