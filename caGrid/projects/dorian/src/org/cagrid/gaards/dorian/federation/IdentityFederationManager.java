...
public class IdentityFederationManager extends LoggingObject implements Publisher {
    ...
    public List<HostRecord> hostSearch(String callerIdentity, HostSearchCriteria criteria) throws RemoteException,
        ...
        try {
            ...
            String mess = "Under the configured host search policy (" + this.conf.getHostSearchPolicy()
    ...
    public List<GridUserRecord> userSearch(String callerIdentity, GridUserSearchCriteria criteria)
        ...
        try {
            ...
            String mess = "Under the configured user search policy (" + this.conf.getUserSearchPolicy()
