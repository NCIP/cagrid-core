 ...
 *          Exp $
 */
public class NoCACredentialsFault extends org.oasis.wsrf.faults.BaseFaultType implements java.io.Serializable {

    /**
	 * 
	 */
	private static final long serialVersionUID = 3450251368754517911L;
    ...
    public NoCACredentialsFault(java.util.Calendar timestamp,
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof NoCACredentialsFault))
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
        NoCACredentialsFault.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cagrid.nci.nih.gov/dorian/bean",
