...
public class HostAgreementSerializer implements Serializer {

    protected static Log LOG = LogFactory.getLog(HostAgreementSerializer.class.getName());
    ...
    public void serialize(QName name, Attributes attributes, Object value, SerializationContext context)
        ...
        try {
            ...
            context.writeString(PolicyUtils.hostAgreementToString((HostAgreement) value));
            context.setWriteXMLType(null);
            // context.writeDOMElement(SAMLUtils.samlAssertionToDOM((SAMLAssertion
            // ) value));
        } catch (Exception e) {
            LOG.error("Error writing HostAgreement to DOM.", e);
        }
    }
