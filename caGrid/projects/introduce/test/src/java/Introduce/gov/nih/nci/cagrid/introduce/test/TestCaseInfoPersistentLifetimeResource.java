...
public class TestCaseInfoPersistentLifetimeResource extends TestCaseInfo {
	...
	public TestCaseInfoPersistentLifetimeResource() {

	}

	public TestCaseInfoPersistentLifetimeResource(String name, String dir, String packageName,
	...
	public String getResourceFrameworkType() {
		return IntroduceConstants.INTRODUCE_PERSISTENT_RESOURCE + "," + IntroduceConstants.INTRODUCE_IDENTIFIABLE_RESOURCE + "," + IntroduceConstants.INTRODUCE_LIFETIME_RESOURCE;
	}
