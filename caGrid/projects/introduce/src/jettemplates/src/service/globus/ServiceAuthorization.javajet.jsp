<%@ page package="gov.nih.nci.cagrid.introduce.templates.service.globus" class="ServiceAuthorizationTemplate" import="gov.nih.nci.cagrid.introduce.extension.ExtensionsLoader,gov.nih.nci.cagrid.introduce.beans.extension.ExtensionType,gov.nih.nci.cagrid.introduce.*,gov.nih.nci.cagrid.introduce.codegen.services.security.info.*,gov.nih.nci.cagrid.introduce.codegen.services.security.tools.*,gov.nih.nci.cagrid.introduce.beans.method.*,gov.nih.nci.cagrid.introduce.beans.service.*,gov.nih.nci.cagrid.introduce.common.*,gov.nih.nci.cagrid.introduce.common.*,gov.nih.nci.cagrid.introduce.codegen.utils.*,gov.nih.nci.cagrid.introduce.codegen.*,gov.nih.nci.cagrid.introduce.beans.namespace.*,java.util.*,gov.nih.nci.cagrid.introduce.beans.resource.*,gov.nih.nci.cagrid.introduce.beans.property.*" %>
