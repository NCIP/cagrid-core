 ...
 * 
 * @author Slava Pestov
 * @version $Id: InputHandler.java,v 1.3 2007-03-01 16:37:35 hastings Exp $
...
public abstract class InputHandler extends KeyAdapter {
	...
	static {
		...
		actions.put(DefaultEditorKit.copyAction, COPY);
		actions.put(DefaultEditorKit.cutAction, CUT);
		actions.put(DefaultEditorKit.pasteAction, PASTE);
