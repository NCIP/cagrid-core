...
public class Introduce_1_5__1_6_Upgrader extends IntroduceUpgraderBase {

    public Introduce_1_5__1_6_Upgrader(IntroduceUpgradeStatus status, ServiceInformation serviceInformation,
        String servicePath) throws Exception {
        super(status, serviceInformation, servicePath, "1.5", "1.6");
    }
