...
public class Introduce_1_4__1_4_1_Upgrader extends IntroduceUpgraderBase {
    ...
    public Introduce_1_4__1_4_1_Upgrader(IntroduceUpgradeStatus status, ServiceInformation serviceInformation,
    ...
    private final class OldJarsFilter implements FileFilter {
        ...
        public boolean accept(File name) {
            ...
            boolean security = (filename.startsWith("caGrid-ServiceSecurityProvider") || filename
                .startsWith("caGrid-metadata-security")) && filename.endsWith(".jar");
    ...
    protected void upgrade() throws Exception {
        // need to replace the ant build scripts
        // copy the existing ones to .OLD files
        ...
        // copy the build scripts out of the skeleton directory into the service
    ...
    private void upgradeJars() throws Exception {
        ...
        for (int i = 0; i < skeletonLibs.length; i++) {
            ...
            try {
                ...
                throw new Exception("Error copying library (" + skeletonLibs[i] + ") to service: " 
                    + ex.getMessage(), ex);
            }
        }

        // remove the old introduce tools jar from 1.4
        ...
        File serviceTasksJar = new File(serviceToolsLibDir.getAbsolutePath() + File.separator
            + "caGrid-Introduce-buildTools-1.4.jar");
        serviceTasksJar.delete();

        // remove the old core jar from 1.4
        File coreJar = new File(serviceToolsLibDir.getAbsolutePath() + File.separator + "caGrid-core-1.4.jar");
        coreJar.delete();
        ...
        // copy new libraries into tools (every thing in skeleton/tools/lib)
