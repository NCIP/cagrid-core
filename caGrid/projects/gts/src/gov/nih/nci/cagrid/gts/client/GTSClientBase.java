 ...
 */
public abstract class GTSClientBase extends ServiceSecurityClient {	
	...
	public GTSClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public GTSClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected GTSPortType createPortType() throws RemoteException {
