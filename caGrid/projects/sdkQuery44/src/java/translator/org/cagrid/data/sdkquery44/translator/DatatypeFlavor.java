...
import gov.nih.nci.iso21090.CodingRationale;
...
public enum DatatypeFlavor {
    ...
    static {
        ...
        CLASS_FLAVORS.put(CodingRationale.class, ENUMERATION);
        CLASS_FLAVORS.put(org.iso._21090.CodingRationale.class, ENUMERATION);
        ...
        CLASS_FLAVORS.put(Pq.class, COMPLEX_WITH_MIXED_CONTENT);
        CLASS_FLAVORS.put(Pqr.class, COMPLEX_WITH_MIXED_CONTENT);
        CLASS_FLAVORS.put(PQR.class, COMPLEX_WITH_MIXED_CONTENT);
