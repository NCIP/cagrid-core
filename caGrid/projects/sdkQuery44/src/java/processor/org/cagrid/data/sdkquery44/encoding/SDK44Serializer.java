...
/**
 * SDK44Serializer
 * Serializes beans from the caCORE SDK version 4.4
 * using Castor to do the heavy lifting
 * 
 * @author David Ervin
 */
public class SDK44Serializer implements Serializer {

	protected static Log LOG = LogFactory.getLog(SDK44Serializer.class.getName());
	...
	public void serialize(QName name, Attributes attributes, Object value, SerializationContext context)
		...
		try {
			Mapping mapping = SDK44EncodingUtils.getMarshallerMapping(context.getMessageContext());
