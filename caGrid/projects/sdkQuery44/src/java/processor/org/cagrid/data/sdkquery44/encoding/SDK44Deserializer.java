...
/**
 * SDK44Deserializer
 * Deserializes beans from the caCORE SDK version 4.4
 * using Castor to do the heavy lifting
 * 
 * @author David
 */
public class SDK44Deserializer extends DeserializerImpl implements Deserializer {
	public QName xmlType;
	public Class<?> javaType;

	protected static Log LOG = LogFactory.getLog(SDK44Deserializer.class.getName());


	public SDK44Deserializer(Class<?> javaType, QName xmlType) {
	...
	public void onEndElement(String namespace, String localName, DeserializationContext context) {
		...
		try {
			Mapping mapping = SDK44EncodingUtils.getUnmarshallerMapping(context.getMessageContext());
			if (mapping != null) {
