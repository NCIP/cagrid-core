package org.cagrid.data.sdkquery44.processor.cql2;
...
import org.cagrid.data.sdkquery44.translator.cql2.CQL2ToParameterizedHQL;
...
/**
 * SDK44CQL2QueryProcessor
 * CQL 2 Query processor for caCORE SDK 4.4 with ISO 21090 data types 
 * 
 * @author David W. Ervin
 */
public class SDK44CQL2QueryProcessor extends CQL2QueryProcessor {
    
    private static Log LOG = LogFactory.getLog(SDK44CQL2QueryProcessor.class);
    ...
    public SDK44CQL2QueryProcessor() {
        super();
    }
