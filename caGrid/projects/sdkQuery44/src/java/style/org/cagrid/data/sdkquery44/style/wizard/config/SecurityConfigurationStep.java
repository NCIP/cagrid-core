...
public class SecurityConfigurationStep extends AbstractStyleConfigurationStep {
    ...
    public void applyConfiguration() throws Exception {
        ...
        setCql1ProcessorProperty(SDK44CQL2QueryProcessor.PROPERTY_USE_STATIC_LOGIN, 
            String.valueOf(isUseStaticLogin()), false);
        setCql1ProcessorProperty(SDK44CQL2QueryProcessor.PROPERTY_USE_GRID_IDENTITY_LOGIN, 
            String.valueOf(isUseCsmGridIdent()), false);
        setCql1ProcessorProperty(SDK44CQL2QueryProcessor.PROPERTY_STATIC_LOGIN_PASS, 
            getStaticLoginPass() != null ? getStaticLoginPass() : "", false);
        setCql1ProcessorProperty(SDK44CQL2QueryProcessor.PROPERTY_STATIC_LOGIN_USER, 
    ...
    public boolean isUsingLocalApi() {
        ...
        try {
            String usingLocalValue = getCql2ProcessorPropertyValue(SDK44CQL2QueryProcessor.PROPERTY_USE_LOCAL_API);
