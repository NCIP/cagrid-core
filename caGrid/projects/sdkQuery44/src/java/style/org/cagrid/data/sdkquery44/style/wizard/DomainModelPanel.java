package org.cagrid.data.sdkquery44.style.wizard;
...
import org.cagrid.data.sdkquery44.style.wizard.model.DomainModelSourcePanel;
import org.cagrid.data.sdkquery44.style.wizard.model.DomainModelSourceValidityListener;
import org.cagrid.data.sdkquery44.style.wizard.model.ModelFromFileSystemPanel;
import org.cagrid.data.sdkquery44.style.wizard.model.ModelFromXmiPanel;
...
public class DomainModelPanel extends AbstractWizardPanel {
    ...
    private void populateModelPanels() {
        ...
        DomainModelSourcePanel configSourcePanel = new ModelFromXmiPanel(validityListener, configuration);
