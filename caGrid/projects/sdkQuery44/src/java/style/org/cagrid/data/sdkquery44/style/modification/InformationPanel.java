package org.cagrid.data.sdkquery44.style.modification;
...
public class InformationPanel extends DataServiceModificationSubPanel {
    ...
    public void updateDisplayedConfiguration() throws Exception {
        String applicationName = getQueryProcessorProperty(
            SDK44CQL2QueryProcessor.PROPERTY_APPLICATION_NAME);
        ...
        String useLocalValue = getQueryProcessorProperty(
        		SDK44CQL2QueryProcessor.PROPERTY_USE_LOCAL_API);
        ...
        if (!useLocal) {
            String hostname = getQueryProcessorProperty(SDK44CQL2QueryProcessor.PROPERTY_HOST_NAME);
            String port = getQueryProcessorProperty(SDK44CQL2QueryProcessor.PROPERTY_HOST_PORT);
            String useHttpsValue = getQueryProcessorProperty(SDK44CQL2QueryProcessor.PROPERTY_HOST_HTTPS);
        ...
        String useGridIdentValue = getQueryProcessorProperty(SDK44CQL2QueryProcessor.PROPERTY_USE_GRID_IDENTITY_LOGIN);
