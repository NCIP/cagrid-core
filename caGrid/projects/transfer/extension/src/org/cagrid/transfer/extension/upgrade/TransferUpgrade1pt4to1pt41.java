...
/**
 * TransferUpgrade1pt4to1pt41
 * Updates transfer from 1.4 to 1.4.1
 * 
 * @author oster
 * @author dervin
 */
public class TransferUpgrade1pt4to1pt41 extends ExtensionUpgraderBase {
    ...
    public TransferUpgrade1pt4to1pt41(ExtensionType extensionType, ServiceInformation serviceInfo, String servicePath,
        String fromVersion, String toVersion) {
        super("TransferUpgrade1pt4to1pt41", extensionType, serviceInfo, servicePath, fromVersion, toVersion);
