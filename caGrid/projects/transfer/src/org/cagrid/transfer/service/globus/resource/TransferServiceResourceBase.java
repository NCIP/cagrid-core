...
public abstract class TransferServiceResourceBase extends ReflectionResource implements Resource
	...
	static final Log logger = LogFactory.getLog(TransferServiceResourceBase.class);

	private TransferServiceResourceConfiguration configuration;
	...
	public TransferServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (TransferServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
