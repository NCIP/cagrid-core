...
public abstract class TransferServiceContextClientBase extends ServiceSecurityClient implements NotifyCallback {	
	...
	public TransferServiceContextClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public TransferServiceContextClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected TransferServiceContextPortType createPortType() throws RemoteException {
		...
		TransferServiceContextPortType port = null;
		try {
			port = locator.getTransferServiceContextPortTypePort(getEndpointReference());
		} catch (Exception e) {
