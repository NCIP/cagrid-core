 ...
 * 
 */
public class TransferServiceContextAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://transfer.cagrid.org/TransferService/Context";
	
	Map authorizationClassMap = new HashMap();
	
	
	public TransferServiceContextAuthorization() {
	}
	...
	public void authorizeGetDataTransferDescriptor(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeSetStatus(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			authorizeGetDataTransferDescriptor(peerSubject, context, operation);
			return true;
			...
			authorizeSetStatus(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
