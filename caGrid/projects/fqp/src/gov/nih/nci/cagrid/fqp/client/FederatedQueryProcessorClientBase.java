 ...
 */
public abstract class FederatedQueryProcessorClientBase extends ServiceSecurityClient {	
	...
	public FederatedQueryProcessorClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public FederatedQueryProcessorClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected FederatedQueryProcessorPortType createPortType() throws RemoteException {
