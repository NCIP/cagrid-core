...
public abstract class FederatedQueryResultsRetrievalResourceBase extends ReflectionResource implements Resource
	...
	static final Log logger = LogFactory.getLog(FederatedQueryResultsRetrievalResourceBase.class);

	private FederatedQueryResultsRetrievalResourceConfiguration configuration;
    ...
    public FederatedQueryResultsRetrievalResourceBase() {
        try {
            resourcePropertyPersistenceHelper = new gov.nih.nci.cagrid.introduce.servicetools.XmlPersistenceHelper(FederatedQueryResultsRetrievalResourceProperties.class,FederatedQueryProcessorConfiguration.getConfiguration());
            resourcePersistenceHelper = new FilePersistenceHelper(this.getClass(),FederatedQueryProcessorConfiguration.getConfiguration(),".resource");
        } catch (Exception ex) {
	...
	public void setTerminationTime(Calendar time) {
		...
		Topic terminationTopic = ((Topic)getResourcePropertySet().get(FederatedQueryResultsRetrievalConstants.TERMINATIONTIME));
	...
	public org.cagrid.fqp.results.metadata.FederatedQueryExecutionStatus getFederatedQueryExecutionStatus(){
		return ((FederatedQueryResultsRetrievalResourceProperties) getResourceBean()).getFederatedQueryExecutionStatus();
	}
	...
	public void setFederatedQueryExecutionStatus(org.cagrid.fqp.results.metadata.FederatedQueryExecutionStatus federatedQueryExecutionStatus ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(FederatedQueryResultsRetrievalConstants.FEDERATEDQUERYEXECUTIONSTATUS);
	...
	public FederatedQueryResultsRetrievalResourceConfiguration getConfiguration() {
		...
		servicePath+="/FederatedQueryResultsRetrieval";
		...
		try {
			...
			this.configuration = (FederatedQueryResultsRetrievalResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
