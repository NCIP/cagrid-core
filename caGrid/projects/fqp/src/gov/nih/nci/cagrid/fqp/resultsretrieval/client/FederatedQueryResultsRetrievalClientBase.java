 ...
 */
public abstract class FederatedQueryResultsRetrievalClientBase extends ServiceSecurityClient implements NotifyCallback {	
	protected FederatedQueryResultsRetrievalPortType portType;
	...
	public FederatedQueryResultsRetrievalClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public FederatedQueryResultsRetrievalClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected FederatedQueryResultsRetrievalPortType createPortType() throws RemoteException {

		FederatedQueryResultsRetrievalServiceAddressingLocator locator = new FederatedQueryResultsRetrievalServiceAddressingLocator();
		...
		FederatedQueryResultsRetrievalPortType port = null;
		try {
			port = locator.getFederatedQueryResultsRetrievalPortTypePort(getEndpointReference());
		} catch (Exception e) {
