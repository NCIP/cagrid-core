 ...
 * 
 */
public class FederatedQueryResultsAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://fqp.cagrid.nci.nih.gov/FederatedResults";
	
	Map authorizationClassMap = new HashMap();
	
	
	public FederatedQueryResultsAuthorization() {
	}
