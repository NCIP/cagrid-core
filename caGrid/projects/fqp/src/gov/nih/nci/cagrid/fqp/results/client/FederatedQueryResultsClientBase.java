...
public abstract class FederatedQueryResultsClientBase extends ServiceSecurityClient implements NotifyCallback {	
	...
	public FederatedQueryResultsClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public FederatedQueryResultsClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected FederatedQueryResultsPortType createPortType() throws RemoteException {
