...
public abstract class FederatedQueryResultsResourceBase extends ReflectionResource implements Resource
	...
	static final Log logger = LogFactory.getLog(FederatedQueryResultsResourceBase.class);

	private FederatedQueryResultsResourceConfiguration configuration;
    ...
    public FederatedQueryResultsResourceBase() {
        try {
            resourcePropertyPersistenceHelper = new gov.nih.nci.cagrid.introduce.servicetools.XmlPersistenceHelper(FederatedQueryResultsResourceProperties.class,FederatedQueryProcessorConfiguration.getConfiguration());
