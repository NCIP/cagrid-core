 ...
 * Federated Query Processor Results Retrieval Resource
 * 
...
public class ResourcePropertyManager {
    ...
    private FederatedQueryResultsRetrievalResource managedResource = null;
    
    public ResourcePropertyManager(FederatedQueryResultsRetrievalResource resource) {
