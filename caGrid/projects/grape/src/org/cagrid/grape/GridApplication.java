...
public class GridApplication extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        try {
            Application app = Utils.deserializeDocument(file.getAbsolutePath(), Application.class);
    ...
    protected void initialize() throws Exception {
        ...
        configurationManager = createConfigurationManager(app.getConfiguration(), cs);
    ...
    protected ConfigurationManager createConfigurationManager(Configuration conf, ConfigurationSynchronizer cs)
        throws Exception {
     ...
     */
    protected javax.swing.JMenuBar getJJMenuBar(List<Component> toolbarComponents) throws Exception {
        if (jJMenuBar == null) {
    ...
    static public class ExecuteComponent extends Runner {
        ...
        public void execute() {
            try {
                Object obj = app.componentClassLoader.loadClass(component.getClassname()).newInstance();
