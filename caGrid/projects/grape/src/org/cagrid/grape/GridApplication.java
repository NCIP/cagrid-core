...
public class GridApplication extends JFrame {
		...
		if (jJMenuBar == null) {
			...
			if (menus != null) {
				...
				if (menu != null) {
					for (int i = 0; i < menu.length; i++) {
						if (!menu[i].getTitle().equals("Help")
								&& !menu[i].getTitle().equals("File"))
							jJMenuBar.add(getMenu(toolbarComponents, null,
									menu[i]));
					}
				}
			}
	...
	private javax.swing.JMenu addToMenu(List<Component> toolbarComponents,
			JMenu parent, Menu menu) {
	...
	private javax.swing.JMenu getMenu(List<Component> toolbarComponents,
	 ...
	 * @return javax.swing.JMenu
	 */
	private javax.swing.JMenu getFileMenu(List<Component> toolbarComponents,
			Menu menu) {
		if (fileMenu == null) {
	...
	private javax.swing.JMenu getHelpMenu(List<Component> toolbarComponents,
			Menu menu) {
		if (helpMenu == null) {
	...
	private void showAboutDialog() {
		JOptionPane.showMessageDialog(this, this.app.getAboutHTML(), "About: "
				+ this.app.getName(), JOptionPane.INFORMATION_MESSAGE,
	...
	public void addApplicationComponent(ApplicationComponent frame,
			Dimensions dim, RenderOptions options) {
		this.lastComp = frame;
			...
			try {
				...
				if (obj instanceof ApplicationComponent) {
					...
					if (this.component.getIcon() != null) {
						comp.setFrameIcon(IconUtils.loadIcon(this.component
								.getIcon()));
					}
					app.addApplicationComponent(comp,
							component.getDimensions(), component
									.getRenderOptions());
