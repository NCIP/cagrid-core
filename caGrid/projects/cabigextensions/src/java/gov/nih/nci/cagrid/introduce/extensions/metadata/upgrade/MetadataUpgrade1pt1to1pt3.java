 ...
 *          dervin Exp $
 */
public class MetadataUpgrade1pt1to1pt3 extends ExtensionUpgraderBase {

    private static final String CAGRID_1_1_METADATA_JAR_PREFIX = "caGrid-1.1-metadata";
    protected MetadataExtensionHelper helper;
    protected static Log LOG = LogFactory.getLog(MetadataUpgrade1pt1to1pt3.class.getName());
     ...
     * @param toVersion
     */
    public MetadataUpgrade1pt1to1pt3(ExtensionType extensionType, ServiceInformation serviceInfo, String servicePath,
        String fromVersion, String toVersion) {
        super("MetadataUpgrade1pt1to1pt3", extensionType, serviceInfo, servicePath, fromVersion, toVersion);
    ...
    private void upgradeJars() {
        FileFilter metadataLibFilter = new FileFilter() {
            public boolean accept(File pathname) {
                ...
                return name.endsWith(".jar") && name.startsWith(CAGRID_1_1_METADATA_JAR_PREFIX)
                    && !name.startsWith(CAGRID_1_1_METADATA_JAR_PREFIX + "-data")
                    && !name.startsWith(CAGRID_1_1_METADATA_JAR_PREFIX + "-security");
            }
        };
