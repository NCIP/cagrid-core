...
public class MetadataUpgrade1pt3 extends ExtensionUpgraderBase {
    ...
    private void upgradeJars() {
        ...
        for (File oldLib : serviceMetadataLibs) {
            oldLib.delete();
            getStatus().addDescriptionLine("caGrid 1.6 library " + oldLib.getName() + " removed fron lib.");
        }
        ...
        for (File oldLib : serviceToolsLibs) {
            oldLib.delete();
            getStatus().addDescriptionLine("caGrid 1.6 library " + oldLib.getName() + " removed from tools lib.");
        }
