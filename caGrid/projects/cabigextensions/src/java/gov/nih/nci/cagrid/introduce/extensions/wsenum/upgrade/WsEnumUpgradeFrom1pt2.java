...
/**
 * WsEnumUpgradeFrom1pt2
 * Upgrades caGrid ws-enumeration support from 1.2 to current
 * 
 * @author ervin
 ...
 *          dervin Exp $
 */
public class WsEnumUpgradeFrom1pt2 extends ExtensionUpgraderBase {
    private static final String CAGRID_WS_ENUM_JAR_PREFIX = "caGrid-wsEnum-";
    private static final String CAGRID_WS_ENUM_JAR_SUFFIX = "-1.2.jar";
    
    private static final String DATA_SERVICE_ENUM_PROPERTY = "dataService_enumIteratorType";
    
    private static Log LOG = LogFactory.getLog(WsEnumUpgradeFrom1pt2.class);

    public WsEnumUpgradeFrom1pt2(ExtensionType extensionType, ServiceInformation serviceInfo, String servicePath,
        String fromVersion, String toVersion) {
        super(WsEnumUpgradeFrom1pt2.class.getSimpleName(),
    ...
    private void upgradeJars() {
        ...
        for (File oldLib : serviceEnumLibs) {
            oldLib.delete();
            String description = "caGrid 1.2 library " + oldLib.getName() + " removed";
