...
/**
 * WsEnumUpgradeFrom1pt4
 * Upgrades caGrid ws-enumeration support from 1.4 to current
 * 
 * @author ervin
 ...
 *          dervin Exp $
 */
public class WsEnumUpgradeFrom1pt4 extends ExtensionUpgraderBase {
    private static final String CAGRID_WS_ENUM_JAR_PREFIX = "caGrid-wsEnum-";
    private static final String CAGRID_WS_ENUM_JAR_SUFFIX = "-1.4.jar";
    
    private static Log LOG = LogFactory.getLog(WsEnumUpgradeFrom1pt4.class);

    public WsEnumUpgradeFrom1pt4(ExtensionType extensionType, ServiceInformation serviceInfo, String servicePath,
        String fromVersion, String toVersion) {
        super(WsEnumUpgradeFrom1pt4.class.getSimpleName(),
