...
public class CQLRetriever extends Retriever {
    ...
    public static gov.nih.nci.cagrid.cqlresultset.CQLQueryResults query(gov.nih.nci.cagrid.cqlquery.CQLQuery cqlQuery,
        String url, String portName) throws Exception {
        ...
        oper.addParameter(new javax.xml.namespace.QName("http://gov.nih.nci.cagrid.data/DataService", "QueryRequest"),
            new javax.xml.namespace.QName("http://gov.nih.nci.cagrid.data/DataService", ">QueryRequest"),
            gov.nih.nci.cagrid.data.stubs.QueryRequest.class, org.apache.axis.description.ParameterDesc.IN, false,
            false);
        ...
        oper
            .setReturnQName(new javax.xml.namespace.QName("http://gov.nih.nci.cagrid.data/DataService", "QueryResponse"));
