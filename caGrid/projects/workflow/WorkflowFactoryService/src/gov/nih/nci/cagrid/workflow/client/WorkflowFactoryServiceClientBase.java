 ...
 */
public abstract class WorkflowFactoryServiceClientBase extends ServiceSecurityClient {	
	...
	public WorkflowFactoryServiceClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public WorkflowFactoryServiceClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected WorkflowFactoryServicePortType createPortType() throws RemoteException {
