 ...
 * 
 */
public abstract class WorkflowServiceImplResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(WorkflowServiceImplResourceBase.class);

	private WorkflowServiceImplResourceConfiguration configuration;
    ...
    public WorkflowServiceImplResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.workflow.stubs.types.WorkflowStatusType getWorkflowStatusElement(){
		return ((WorkflowServiceImplResourceProperties) getResourceBean()).getWorkflowStatusElement();
	}
	
	public void setWorkflowStatusElement(gov.nih.nci.cagrid.workflow.stubs.types.WorkflowStatusType workflowStatusElement ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(WorkflowServiceImplConstants.WORKFLOWSTATUSELEMENT);
		prop.set(0, workflowStatusElement);
	}
	...
	public WorkflowServiceImplResourceConfiguration getConfiguration() {
		...
		servicePath+="/WorkflowServiceImpl";
