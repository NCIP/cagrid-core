 ...
 * 
 */
public class WorkflowServiceImplAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://workflow.cagrid.nci.nih.gov/WorkflowServiceImpl";
	
	Map authorizationClassMap = new HashMap();
	
	
	public WorkflowServiceImplAuthorization() {
	}
