 ...
 * 
 */
public abstract class WorkflowFactoryServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(WorkflowFactoryServiceResourceBase.class);

	private WorkflowFactoryServiceResourceConfiguration configuration;
    ...
    public WorkflowFactoryServiceResourceBase() {
    }
	...
	public WorkflowFactoryServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/WorkflowFactoryService";
		...
		try {
			...
			this.configuration = (WorkflowFactoryServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
