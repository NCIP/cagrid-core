 ...
 * 
 */
public class WorkflowFactoryServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://workflow.cagrid.nci.nih.gov/WorkflowFactoryService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public WorkflowFactoryServiceAuthorization() {
	}
