 ...
 */
public abstract class WorkflowServiceImplClientBase extends ServiceSecurityClient {	
	...
	public WorkflowServiceImplClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public WorkflowServiceImplClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected WorkflowServiceImplPortType createPortType() throws RemoteException {
