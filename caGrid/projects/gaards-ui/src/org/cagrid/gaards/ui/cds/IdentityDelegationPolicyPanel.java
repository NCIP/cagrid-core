...
public class IdentityDelegationPolicyPanel extends DelegationPolicyPanel {
    ...
    private void initialize() {
        ...
        this.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Identity Delegation Policy",
        ...
        if (addButton == null) {
            ...
            addButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    ...
                    if (gridId == null) {
                        GridApplication.getContext().showMessage("Please specify a Grid Identity.");
                    }
            ...
            removeButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    try {
                        ...
                        GridApplication.getContext().showMessage(ex.getMessage());
                    }
                }
            });
        }
