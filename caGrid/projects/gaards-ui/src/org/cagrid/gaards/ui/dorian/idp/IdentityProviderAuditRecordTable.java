...
public class IdentityProviderAuditRecordTable extends GrapeBaseTable {
    ...
    public synchronized IdentityProviderAuditRecord getSelectedRecord() throws Exception {
    ...
    public void doubleClick() throws Exception {
        try {
            GridApplication.getContext().addApplicationComponent(new IdentityProviderRecordWindow(getSelectedRecord()),
                600, 400);
        } catch (Exception ex) {
