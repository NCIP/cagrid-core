...
public class DelegateProxyWindowStep1 extends ApplicationComponent implements ProxyLifetimeListener {
    ...
    public void handleDelegationPathLengthSelection() {
        ...
        if (getDelegatedCredentialPathLength().getSelectedItem() != null) {
            maxPathLength = ((Integer) getDelegatedCredentialPathLength().getSelectedItem()).intValue() - 1;
        }
        if (maxPathLength < 0) {
            maxPathLength = 0;
        }
    ...
    private JComboBox getDelegatedCredentialPathLength() {
        if (delegatedCredentialPathLength == null) {
            ...
            delegatedCredentialPathLength.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
    ...
    public void handleProxyLifetimeChange() {
        ...
        long seconds = ((l.getHours() * 60 * 60) + (l.getMinutes() * 60) + l.getSeconds()) - SECONDS_OFFSET;
        if (seconds < 0) {
            seconds = 0;
        }
    ...
    private JPanel getTitlePanel() {
        if (titlePanel == null) {
            titlePanel = new TitlePanel("Delegate Credential",
                "Delegate your credential to another party such that they may act on your behalf.");
        }
        return titlePanel;
    }
