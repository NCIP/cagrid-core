...
public class IdentityProviderAuditPanel extends JPanel {
	...
	private IdentityProviderAuditComboBox auditType = null;
	...
	private IdentityProviderAuditRecordTable auditRecords = null;
	 ...
	 */
	public IdentityProviderAuditPanel(DorianSessionProvider session) {
		this(session, null);
	}
	...
	private void performAudit() {
		...
		try {
			...
			LocalAdministrationClient client = this.session.getSession().getLocalAdminClient();
			List<IdentityProviderAuditRecord> records = client.performAudit(f);
	 ...
	 */
	private IdentityProviderAuditComboBox getAuditType() {
		if (auditType == null) {
			auditType = new IdentityProviderAuditComboBox();
		}
		return auditType;
	}
	 ...
	 */
	private IdentityProviderAuditRecordTable getAuditRecords() {
		if (auditRecords == null) {
			auditRecords = new IdentityProviderAuditRecordTable();
		}
		return auditRecords;
	}
