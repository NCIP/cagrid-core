 ...
 *          Exp $
 */
public class IdentityProviderAuditSearchWindow extends ApplicationComponent {
	...
	private IdentityProviderAuditPanel auditPanel = null;
	 ...
	 */
	public IdentityProviderAuditSearchWindow() {
		super();
		initialize();
	}
	 ...
	 * @return javax.swing.JPanel
	 */
	private IdentityProviderAuditPanel getAuditPanel() {
		if (auditPanel == null) {
			auditPanel = new IdentityProviderAuditPanel(getSessionPanel());
	...
	private JPanel getTitlePanel() {
		if (titlePanel == null) {
			titlePanel = new TitlePanel("Audit Search","Perform a search on the identity provider audit records.");
		}
		return titlePanel;
	}
