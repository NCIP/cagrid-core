...
public class FederationAuditPanel extends JPanel {
    ...
    public FederationAuditPanel(DorianSessionProvider session, int mode, String target) {
        super();
    ...
    private void performAudit() {
        ...
        try {
            ...
            GridAdministrationClient client = this.session.getSession().getAdminClient();
    ...
    private void setupAuditTypes(int mode) {
        ...
        if (mode == GRID_ACCOUNT_MODE) {
            ...
            this.auditTypes.add(FederationAudit.SuccessfulUserCertificateRequest);
            this.auditTypes.add(FederationAudit.InvalidUserCertificateRequest);
    ...
    private JPanel getSearchCriteria() {
        if (searchCriteria == null) {
            ...
            searchCriteria.setBorder(BorderFactory.createTitledBorder(null, "Search Criteria",
    ...
    private String findIdentity() {
        ...
        return dialog.getSelectedIdentity();
    }
    ...
    private JButton getSelectStartDate() {
        if (selectStartDate == null) {
            ...
            selectStartDate.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
    ...
    private JButton getSelectEndDate() {
        if (selectEndDate == null) {
            ...
            selectEndDate.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    SelectDateDialog dialog = new SelectDateDialog(false);
                    dialog.setModal(true);
                    GridApplication.getContext().showDialog(dialog);
    ...
    private JScrollPane getTablePanel() {
        if (tablePanel == null) {
            ...
            tablePanel.setBorder(BorderFactory.createTitledBorder(null, "Audit Results",
                TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, LookAndFeel
                    .getPanelLabelColor()));
        }
        return tablePanel;
