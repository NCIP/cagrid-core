...
public class OneTimePasswordAuthenticationPanel extends CredentialPanel {
	 ...
	 */
	public OneTimePasswordAuthenticationPanel() {
		super();
		initialize();
	}
	...
	public Credential getCredential() throws Exception{
		OneTimePassword credential =  new OneTimePassword();
		credential.setUserId(Utils.clean(getUserId().getText()));
		credential.setOneTimePassword(Utils.clean(new String(getPassword().getPassword())));
		return credential;
	}
