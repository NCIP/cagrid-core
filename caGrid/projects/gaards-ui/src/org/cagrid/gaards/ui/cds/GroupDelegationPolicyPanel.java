...
public class GroupDelegationPolicyPanel extends DelegationPolicyPanel {
    ...
    public GroupDelegationPolicy getPolicy() {
        ...
        policy.setGridGrouperServiceURL(Utils.clean(getGridGrouperURL().getText()));
    ...
    private void initialize() {
        ...
        this.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Group Delegation Policy",
