 ...
 * 
 */
public class SyncGTSResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(SyncGTSResourceHome.class);
	...
	public Resource find(ResourceKey key) throws ResourceException {
		SyncGTSResource resource = (SyncGTSResource) super.find(key);
		return resource;
	}
     ...
     */
    public SyncGTSResource getAddressedResource() throws Exception {
        SyncGTSResource thisResource;
        thisResource = (SyncGTSResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
}