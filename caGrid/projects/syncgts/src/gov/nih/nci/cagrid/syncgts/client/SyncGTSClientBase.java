 ...
 */
public abstract class SyncGTSClientBase extends ServiceSecurityClient {	
	...
	public SyncGTSClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public SyncGTSClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected SyncGTSPortType createPortType() throws RemoteException {
