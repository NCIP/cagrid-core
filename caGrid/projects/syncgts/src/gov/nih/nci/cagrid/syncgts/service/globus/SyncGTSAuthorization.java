 ...
 * 
 */
public class SyncGTSAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://cagrid.nci.nih.gov/SyncGTS";
	
	Map authorizationClassMap = new HashMap();
	
	
	public SyncGTSAuthorization() {
	}
