...
import gov.nih.nci.cagrid.syncgts.common.SyncGTSConstants;
import gov.nih.nci.cagrid.syncgts.stubs.SyncGTSResourceProperties;
import gov.nih.nci.cagrid.syncgts.service.SyncGTSConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class SyncGTSResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  {

	static final Log logger = LogFactory.getLog(SyncGTSResourceBase.class);

	private SyncGTSResourceConfiguration configuration;
	...
	public SyncGTSResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (SyncGTSResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
