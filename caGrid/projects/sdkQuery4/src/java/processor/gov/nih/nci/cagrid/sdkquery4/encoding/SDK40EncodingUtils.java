...
public class SDK40EncodingUtils {
    ...
    protected static Map<String, String> resourceMap = Collections.synchronizedMap(new HashMap<String, String>());
        ...
        if (context != null) {
            ...
            if (prop != null && !prop.trim().equals("")) {
                ...
                if (prop != null && !prop.trim().equals("")) {
                    ...
                    // walk through the WSDD config and find the property in
