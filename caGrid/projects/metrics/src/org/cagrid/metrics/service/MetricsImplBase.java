 ...
 * 
 */
public abstract class MetricsImplBase {
	
	public MetricsImplBase() throws RemoteException {
	...
	public org.cagrid.metrics.service.globus.resource.BaseResourceHome getResourceHome() throws Exception {
		ResourceHome resource = getResourceHome("home");
		return (org.cagrid.metrics.service.globus.resource.BaseResourceHome)resource;
	}
	...
	protected Object getMetadata(QName metadataQName) {
		MetricsResource serviceBaseResource = null;
		try {
			serviceBaseResource = (MetricsResource) ResourceContext.getResourceContext().getResource();
		} catch (ResourceContextException e) {
			return null;
