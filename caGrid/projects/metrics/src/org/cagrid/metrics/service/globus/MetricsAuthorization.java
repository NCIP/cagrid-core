 ...
 * 
 */
public class MetricsAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://metrics.cagrid.org/Metrics";
	
	
	public MetricsAuthorization() {
	}
