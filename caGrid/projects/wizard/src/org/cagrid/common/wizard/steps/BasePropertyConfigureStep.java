...
public abstract class BasePropertyConfigureStep extends PanelWizardStep {
	 ...
	 * 
	 */
	public BasePropertyConfigureStep(Map globalMap) {
		super();
	...
	public void addTextOption(String key, String value, String description) {
		this.myOptionsKeys.add(key);
